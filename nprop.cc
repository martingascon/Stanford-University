...
axis->SetLimits(10,1450); // along X 
gr1->Draw("ap");	


TLine *tl= new TLine();
tl->SetLineStyle(9);
tl->DrawLine(10,1,1450,1);
...
char *sepa; sepa= strtok(argv[1],"PHvsE_ K");  sepa= strtok(argv[1],"PHvsE_ K");	 m1=sprintf(latex1,"T = %s K",sepa);
tx1->DrawLatex(0.7,0.45,latex1);
...
if (argc>2)
	...
	sepa= strtok(argv[2],"PHvsE_ K");  sepa= strtok(argv[2],"PHvsE_ K");	 
	m1=sprintf(latex2,"T = %s K",sepa);
	tx2->DrawLatex(0.7,0.40,latex2);
...
if (argc>3)
	...
	sepa= strtok(argv[3],"PHvsE_ K");  sepa= strtok(argv[3],"PHvsE_ K");	 
	m1=sprintf(latex3,"T = %s K",sepa);
...
if (argc>4)
	...
	sepa= strtok(argv[4],"PHvsE_ K");  sepa= strtok(argv[4],"PHvsE_ K");	 
	m1=sprintf(latex4,"T = %s K",sepa);
...
if (argc>5)
	...
	sepa= strtok(argv[5],"PHvsE_ K");  sepa= strtok(argv[5],"PHvsE_ K");	 
	m1=sprintf(latex5,"T = %s K",sepa);
...
if (argc>6)
	...
	sepa= strtok(argv[6],"PHvsE_ K");  sepa= strtok(argv[6],"PHvsE_ K");	 
	m1=sprintf(latex6,"T = %s K",sepa);
...
if (argc>7)
	...
	sepa= strtok(argv[7],"PHvsE_ K");  sepa= strtok(argv[7],"PHvsE_ K");	 
	m1=sprintf(latex7,"T = %s K",sepa);
