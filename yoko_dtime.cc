...
#define Amax 10				// 10 for CsI(Tl)  //450 for LSO
#define Amin 3				// 1 for CsI(Tl)  // 80 for LSO
#define FILES 1
#define GRAPH 1

#define Elem 2 			// 1: CsI(Tl)-1comp   2: CsI(Tl)-2comp.  3: LaBr3  4: LSO 
...
Char_t fitf[100]="[0]*exp(-x/[1])",fitf2[100]="[0]*exp(x/[1])",fitf3[100]="[0]*exp(-x/[1])+[0]*(-1)*exp(-x/[4])+[2]*exp(-x/[3])",fitf4[100]="[0]*exp(-x/[1])+[2]*exp(-x/[3])";
//Char_t fitf5[100]="(([0]/([1]-[2]))*exp(-x/[1]))+(([0]/([1]-[2]))*(-1)*exp(-x/[2]))+([3]/[2]*exp(-x/[2]))";
//variables for the filter
//Float_t sum11,sum21,phi1[N],Emax1; 
